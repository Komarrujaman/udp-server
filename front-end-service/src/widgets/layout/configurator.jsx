...
export function Configurator() {
  ...
  const sidenavColors = {
    ...
    white: "from-orange-400 to-orange-700",
    dark: "from-orange-400 to-orange-700",
    green: "from-green-400 to-green-600",
    red: "from-orange-400 to-orange-700",
      ...
      <div className="py-4 px-6">
        <div className="mb-12">
          ...
          <div className="mt-3 flex items-center gap-2">
            {Object.keys(sidenavColors).map((color="bg-orange-700") => (
              <span
                key={color}
                className={`h-6 w-6 cursor-pointer rounded-full border bg-gradient-to-br transition-transform hover:scale-105 ${
                  sidenavColors[color]
                } ${
                  sidenavColor === color ? "border-orange-600" : "border-transparent"
                }`}
