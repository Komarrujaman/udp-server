...
export function DashboardNavbar() {
  ...
  return (
    <Navbar
      className={`rounded-xl transition-all justify-center border-none bg-opacity-50 ${
        fixedNavbar
      ...
      <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
        ...
        <div className="flex items-center justify-between md:justify-normal">
          ...
          <Button
            ...
            >
              <HomeIcon className="h-5 w-5 text-main" />
              Home
            </Button>
            <IconButton
              variant="text"
          ...
          <Link to="add-device">
            <Button
              ...
              className="hidden items-center gap-1 px-4 xl:flex normal-case"
            >
              <ServerStackIcon className="h-5 w-5 text-main" />
              Add Device
            </Button>
            <IconButton
              variant="text"
          ...
          <Link to="devicelist">
            <Button
              ...
              className="hidden items-center gap-1 px-4 xl:flex normal-case"
            >
              <TableCellsIcon className="h-5 w-5 text-main" />
              Devices List
            </Button>
            <IconButton
              variant="text"
          ...
          <Link to="adduser">
            <Button
              ...
              className="hidden items-center gap-1 px-4 xl:flex normal-case"
            >
              <UserGroupIcon className="h-5 w-5 text-main" />
              Add User
            </Button>
            <IconButton
              variant="text"
          ...
          <div to="adduser" onClick={handleLogout}>
            <Button
              ...
              className="hidden items-center gap-1 px-4 xl:flex normal-case"
            >
              <PowerIcon className="h-5 w-5 text-main" />
              Log Out
            </Button>
            <IconButton
              variant="text"
